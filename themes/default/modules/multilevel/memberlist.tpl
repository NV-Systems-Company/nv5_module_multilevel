<!-- BEGIN: main -->
<!-- BEGIN: view -->
<form class="form-inline" action="{LINK.search}" method="get">
	...
	<table class="table table-borderless">
	   <thead>
		<tr>
		  ...
		  <h6 class="text-center  m-0 font-weight-bold text-primary">
		  <strong>DANH SÁCH NHÀ PHÂN PHỐI</strong></h6></th>
		</tr>
	  </thead>
	  <tbody>
		<tr>
		  <td>
		  <input class="w300 form-control" type="text" value="{Q}" name="q" maxlength="255" placeholder="Tìm kiếm"/>
		  </td>
		  <td>
		  <button class="btn btn-primary" type="submit"/>
		  <i class="fa fa-search"></i>  {LANG.search}</button>
		  </td>
		  <td><a href="{LINK.add}" class="btn btn-success"> 
		  {LANG.add_customer}</a></td>
