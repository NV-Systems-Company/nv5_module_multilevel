...
if (!nv_function_exists('nv_block_login')) {
    ...
    function nv_block_login($block_config)
    {
        ...
        if ($global_config['allowuserlogin']) {
            ...
            $xtpl = new XTemplate('block.login.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $module);
            ...
            if ($mod_file != $module_file) {
                if (file_exists(NV_ROOTDIR . '/modules/' . $module . '/language/' . NV_LANG_INTERFACE . '.php')) {
                    ...
                    include NV_ROOTDIR . '/modules/' . $module . '/language/vi.php';
                }
            ...
            if (defined('NV_IS_USER')) {
                ...
                $xtpl->assign('USER_REGISTER', NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=multilevel&amp;' . NV_OP_VARIABLE . '=register');
