...
$db->sqlreset()
    ...
    ->join('INNER JOIN ' . $db_config['prefix'] . '_shops_rows t2 ON t1.productid=t2.id WHERE t1.customerid=0' . $where);


$num_items = $db->query($db->sql())->fetchColumn();
$db->select('t1.*, t2.' . NV_LANG_DATA . '_title AS title_product')->order('t2.id, t1.addtime DESC');
